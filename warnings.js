...
warnings.sendReport = function (date, cb) {
    emailServer.send({
        ...
        This is a daily loudness report generated by the stream monitor.
        ...
        attachment:
        [
            { path:"./generated/integrated.svg", type: "image/svg", name: "integrated.svg" },
            { path:"./generated/momentary.svg", type: "image/svg", name: "momentary.svg" },
            { path:`./logs/${date}.csv`, type: "application/csv", name: date + '.csv' },
        ]
